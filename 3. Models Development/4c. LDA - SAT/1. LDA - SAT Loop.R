...
# Save final result
write.xlsx(final.result,'~/GitHub/NextBigCrypto-Senti/3. Models Development/0. LDA-SAT_result.xlsx')

# Save model
save.image('~/GitHub/NextBigCrypto-Senti/Models/LDA-SAT_LOOP_1106.RData')
